...
MIDI_NOTES = [41, 45, 48, 57, 42, 60, 62, 43, 37, 38, 40, 75, 49, 35, 36, 55] #TODO: Config
...
class Input:
    ...
    def process_message(self, message):
        if message.type == 'note_on' and message.note in MIDI_NOTES:
            self.presenter.note_on(MIDI_NOTES.index(message.note), message.velocity)
        elif message.type == 'note_off' and message.note in MIDI_NOTES:
